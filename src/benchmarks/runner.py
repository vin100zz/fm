...
from benchmarks.suites import match_possession as suite_match_possession
...
from benchmarks.suites import stats_match_possession as suite_stats_match_possession

_RACINE = Path(__file__).resolve().parent.parent.parent
_SUITES = {
    "match": suite_match.executer,
    "match_possession": suite_match_possession.executer,
    "performance": suite_performance.executer,
    "stats_match": suite_stats_match.executer,
    "stats_match_possession": suite_stats_match_possession.executer,
}
